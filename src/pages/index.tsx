  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Restaurant Booking Engine, where you can easily reserve tables and manage your reservations and menus. Streamlining restaurant management one reservation at a time."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Booking Engine, where you can easily reserve tables and manage your reservations and menus. Streamlining restaurant management one reservation at a time.`}
            </Text>
            <Box
